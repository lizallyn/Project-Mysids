...
A model was constructed with whale count as the response and mysid count as the predictor, with sample Site as a random effect to account for repeated measures. The model with the random effect of Site had a delta AIC of 0.9 compared to the model with no random effect, but including it makes sense for the structure of the data. This model was compared against the null intercept model using AIC.
