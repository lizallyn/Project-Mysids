...
What if we look at region-wide per month. Average number of mysids per sample per day. Total number of unique whales in the study area per day where samples were taken. 
