...
Any kind of summary would be kind of like adding Day or Month as a random effect? Maybe first look at whales per day in total area, with Site, Date as random effects.
...
Data are overdispersed, do the same negative binomial hurdle as before.

```{r}
glmm.daily.1 <- glmmTMB(data = daily, UniqueW ~ AvgMysids, family = truncated_nbinom1, ziformula = ~.)
